...
public class ThePriceIsRightCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThePriceIsRightCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThePriceIsRightIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThePriceIsRightIW/InitOutcome.xml").getDocumentElement();
